...
1. Download the WATER_ENGINE.zip
2. Run PLAY.exe to launch the game
3. Load the only available level
4. Have fun !
...
Wads used :
Classic Keys (Relaunched for 2009) by karlo002
Shatterable Dark Wooden Crate by LGG-PRODUCTION
Pipes by NinaCroft
Thor10 for the hand meshes of Lara
